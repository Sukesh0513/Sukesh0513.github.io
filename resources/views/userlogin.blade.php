                ...
                <div class="row" style="margin-top:15%">
                    ...
                    <div class="col-md-4 jumbotron" style="border:0px solid black;background:transparent;padding:1px;" >
                        <div class="row  text-center" >
                                ...
                                <div class="col-lg-6 ">
                                     <a href="userlogin" class="btn btn-danger text-center " role="button" style="width:100%; font-family:'Trebuchet MS';font-size: 1rem"><span class="barge"><img src="pic1.png" style="height:25px;width:25px;"/></span>I have account</a>
                                </div>                                
                                <div class="col-lg-6 ">
                                    <a href="usersignup" class="btn btn-info" role="button"style="width:100%;background:#5bc0de;font-family:'Trebuchet MS';font-size: 1rem"><span class="barge"><img src="pic3.png" style="height:25px;width:25px;"/></span>New User</a>
                                </div>
                             <!--   <div class="col-md-2">
                                    </div>
                        ...
                        <div class="row" style="height:20px;">
                         ...
                         <!--  <div class="">-->
                         <form class="form-container" action="userlogin" method="post">
                                @csrf

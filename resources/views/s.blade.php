<html>
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light fixed-top hello">
                <div class="container">
                        <a class="navbar-brand text-center" href="#" style="font-weight:light;color:white;font-size:50px">E<span id="size">BIZ</span></a>
                          ...
                          <ul class="navbar-nav ml-auto" >
                            <li class="nav-item active " >
                             <!-- <a class="nav-link" href="#">Shop <span class="sr-only">(current)</span></a>-->
                              <a class="nav-link btn two" role="button" href="shope2"  style="color:white;font-size:18px"><i class="fa fa-home fa1"></i> Shop <span class="sr-only">(current)</span></a>
                            </li>
                        ...
                        <ul class="dropdown-menu text-center dropul" aria-labelledby="hello">
                            ...
                            <li class="nav-item">
                                    <a class="nav-link btn btn-outline-light one" role="button" href="logout"  style="color:white;font-size:18px"><i class="fa fa-sign-out fa4" aria-hidden="true"></i> Logout </a>
                            </li>
                          </ul>
            ...
            <div id="carouselExampleIndicators" class="carousel slide " data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            ...
                            <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <p>kakinada's first online shopping website....!</p>
                                </div>
                        </div>
                 ...
                 <div class="image">
                        <div class="owl-carousel owl-theme">
                            ...
                            <div class="name">
                                <div class="item">
                                <a href="category?cat={{$Catalog->id}}"><img src='../storage/app/{{$Catalog->img}}'/></a>
                                </div>
                  ...
                  <div class="image">
                      ...
                      <hr style="border-bottom:1px solid grey"/>
                        ...
                        <?php
                            ...
                            <div class="name">
                                <div class="item">
                                <a href="viewproduct?id={{$product->id}}"><img src='../storage/app/{{$product->img}}'/></a>
                                </div>
